...
class __TwigTemplate_5d52e56e8fa26fe0b034d5e0e0654572 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        if ((($context["items"] ?? null) || ($context["empty"] ?? null))) {
            ...
            if ((($tmp = ($context["items"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", ["list-group"], "method", false, false, true, 32), "html", null, true);
                yield ">";
                // line 33
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 34
                    yield "<li";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 34), "addClass", ["list-group-item"], "method", false, false, true, 34), "html", null, true);
                    yield ">";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/dataset/item-list.html.twig", "/home/dickyv/repos/drupal_news/web/themes/contrib/bootstrap_barrio/templates/dataset/item-list.html.twig");
    }
