...
class __TwigTemplate_61e8b50e9c8f70536bcee3a2b83faf75 extends Template
{
...
($context["long"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("filter-" . Twig\Extension\CoreExtension::replace(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig", "/home/dickyv/repos/drupal_news/web/themes/contrib/bootstrap_barrio/templates/content-edit/filter-tips.html.twig");
    }
